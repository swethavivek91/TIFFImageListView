...
import com.app.listapp.tiff.exceptions.CantOpenFileException;
import com.app.listapp.tiff.exceptions.DecodeTiffException;
import com.app.listapp.tiff.exceptions.NotEnoughtMemoryException;
...
public class TiffBitmapFactory {
     ...
     *         decoded
     *
     * @throws com.app.listapp.tiff.exceptions.DecodeTiffException when error occure while decoding image
     * @throws com.app.listapp.tiff.exceptions.CantOpenFileException when {@code file} not exist or {@code file} is not tiff image
     * @throws com.app.listapp.tiff.exceptions.NotEnoughtMemoryException when for decoding of image system need more memory than {@link Options#inAvailableMemory} or default value
     */
     ...
     * @throws com.app.listapp.tiff.exceptions.DecodeTiffException when error occure while decoding image
     * @throws com.app.listapp.tiff.exceptions.CantOpenFileException when {@code file} not exist or {@code file} is not tiff image
     * @throws com.app.listapp.tiff.exceptions.NotEnoughtMemoryException when {@link Options#inAvailableMemory} not enought to decode image
     */
    ...
    public static final class Options {
         ...
         * <p>For storing orientation uses {@link com.app.listapp.Orientation ImageOrientation} enum</p>
        ...
        /**
         * The number of pixels per {@link TiffBitmapFactory.Options#outResolutionUnit} in the ImageWidth direction.
         */
        public float outXResolution;

        /**
         * The number of pixels per {@link TiffBitmapFactory.Options#outResolutionUnit} in the ImageHeight direction.
         */
