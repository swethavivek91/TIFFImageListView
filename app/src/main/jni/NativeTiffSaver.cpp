...
extern "C" {
    ...
    JNIEXPORT jboolean JNICALL Java_com_app_listapp_tiff_TiffSaver_save
    (JNIEnv *env, jclass clazz, jstring filePath, jobject bitmap, jobject options, jboolean append) {

        //Options class
        jclass jSaveOptionsClass = env->FindClass("com/app/listapp/tiff/TiffSaver$SaveOptions");
...
*/
        ...
        jclass jBuildConfigClass = env->FindClass(
                "com/app/listapp/tiff/BuildConfig");
