...
JNIEXPORT jboolean JNICALL Java_com_app_listapp_tiff_TiffConverter_convertTiffPng
...
JNIEXPORT jboolean JNICALL Java_com_app_listapp_tiff_TiffConverter_convertTiffJpg
  (JNIEnv *env, jclass clazz, jstring tiffPath, jstring pngPath, jobject options, jobject listener)
  {
...
JNIEXPORT jboolean JNICALL Java_com_app_listapp_tiff_TiffConverter_convertTiffBmp
...
JNIEXPORT jboolean JNICALL Java_com_app_listapp_tiff_TiffConverter_convertPngTiff
...
JNIEXPORT jboolean JNICALL Java_com_app_listapp_tiff_TiffConverter_convertJpgTiff
  (JNIEnv *env, jclass clazz, jstring pngPath, jstring tiffPath, jobject options, jobject listener)
  {
...
JNIEXPORT jboolean JNICALL Java_com_app_listapp_tiff_TiffConverter_convertBmpTiff
  ...
  JNIEXPORT jobject JNICALL Java_com_app_listapp_tiff_TiffConverter_readBmp
...
JNIEXPORT jobject JNICALL Java_com_app_listapp_tiff_TiffConverter_getImageType
