...
NativeDecoder::NativeDecoder(JNIEnv *e, jclass c, jstring path, jobject opts, jobject listener)
{
    ...
    jBitmapOptionsClass = env->FindClass(
                        "com/app/listapp/tiff/TiffBitmapFactory$Options");
    jIProgressListenerClass = env->FindClass("com/app/listapp/tiff/IProgressListener");
...
jobject NativeDecoder::getBitmap()
{
        ...
        jfieldID gOptions_PreferedConfigFieldID = env->GetFieldID(jBitmapOptionsClass,
                                                                  "inPreferredConfig",
                                                                  "Lcom/app/listapp/tiff/TiffBitmapFactory$ImageConfig;");
        ...
        if (config == NULL) {
            ...
            jclass bitmapConfig = env->FindClass(
                    "com/app/listapp/tiff/TiffBitmapFactory$ImageConfig");
        ...
        jfieldID gOptions_DecodeAreaFieldId = env->GetFieldID(jBitmapOptionsClass, "inDecodeArea",
                                                                "Lcom/app/listapp/tiff/DecodeArea;");
        ...
        if (decodeArea) {
            ...
            jclass decodeAreaClass = env->FindClass("com/app/listapp/tiff/DecodeArea");
...
void NativeDecoder::writeDataToOptions(int directoryNumber)
{
    TIFFSetDirectory(image, directoryNumber);
        ...
        jclass gOptions_ImageOrientationClass = env->FindClass(
            "com/app/listapp/tiff/Orientation");
        ...
        switch (origorientation) {
            case ORIENTATION_TOPLEFT:
                gOptions_ImageOrientationFieldId = env->GetStaticFieldID(gOptions_ImageOrientationClass,
                    "TOP_LEFT",
                    "Lcom/app/listapp/tiff/Orientation;");
                break;
            case ORIENTATION_TOPRIGHT:
                gOptions_ImageOrientationFieldId = env->GetStaticFieldID(gOptions_ImageOrientationClass,
                    "TOP_RIGHT",
        ...
        */
        ...
        jclass gOptions_ResolutionUnitClass = env->FindClass("com/app/listapp/tiff/ResolutionUnit");
        ...
        switch(resunit) {
            case RESUNIT_INCH:
                gOptions_ResolutionUnitFieldId = env->GetStaticFieldID(gOptions_ResolutionUnitClass,
                            "INCH",
                            "Lcom/app/listapp/tiff/ResolutionUnit;");
                break;
        ...
        jclass gOptions_PlanarConfigClass = env->FindClass("com/app/listapp/tiff/PlanarConfig");
        ...
        switch(planarConfig) {
            case PLANARCONFIG_CONTIG:
                ...
                "CONTIG",
                "Lcom/app/listapp/tiff/PlanarConfig;");
                break;
        ...
        jclass gOptions_ImageCompressionClass = env->FindClass(
            "com/app/listapp/tiff/CompressionScheme");
        ...
        case COMPRESSION_NONE:
            gOptions_ImageCompressionFieldId = env->GetStaticFieldID(gOptions_ImageCompressionClass,
                "NONE",
                "Lcom/app/listapp/tiff/CompressionScheme;");
            break;
