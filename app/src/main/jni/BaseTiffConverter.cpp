...
BaseTiffConverter::BaseTiffConverter(JNIEnv *e, jclass clazz, jstring in, jstring out, jobject opts, jobject listener)
{
    ...
    jConvertOptionsClass = env->FindClass("com/app/listapp/tiff/TiffConverter$ConverterOptions");
...
void BaseTiffConverter::readOptions()
{
    ...
    jclass compressionModeClass = env->FindClass("com/app/listapp/tiff/CompressionScheme");
    ...
    jclass orientationClass = env->FindClass("com/app/listapp/tiff/Orientation");
    ...
    jclass resolutionUnitClass = env->FindClass("com/app/listapp/tiff/ResolutionUnit");
