...
void throw_not_enought_memory_exception(JNIEnv *env, int available, int need)
{
    ...
    jobject exObj;
    const char *className = "com/app/listapp/tiff/exceptions/NotEnoughtMemoryException" ;
...
void throw_decode_file_exception(JNIEnv *env, jstring str, jstring additionalInfo)
{
    ...
    jmethodID exConstructorID;
    jobject exObj;
    const char *className = "com/app/listapp/tiff/exceptions/DecodeTiffException" ;
...
void throw_cant_open_file_exception(JNIEnv *env, jstring str)
{
    ...
    jmethodID exConstructorID;
    jobject exObj;
    const char *className = "com/app/listapp/tiff/exceptions/CantOpenFileException" ;
